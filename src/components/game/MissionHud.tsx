...
export const MissionHud: React.FC<MissionHudProps> = ({
  ...
  return (
    <div className="fixed top-36 left-6 max-w-md w-[calc(100vw-3rem)] sm:w-full max-h-[calc(100vh-11rem)] overflow-y-auto backdrop-blur-xl bg-slate-950/90 p-5 border border-slate-800/90 rounded-2xl z-40 shadow-2xl space-y-3 transition-all duration-300">
