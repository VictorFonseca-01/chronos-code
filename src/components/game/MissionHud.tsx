...
export const MissionHud: React.FC<MissionHudProps> = ({
  ...
  return (
    <div className="fixed top-32 left-6 z-40 max-w-sm backdrop-blur-md bg-slate-950/80 p-5 border border-slate-800 rounded-xl shadow-xl space-y-3 transition-all duration-300">
